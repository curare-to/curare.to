...
import { closedSchemaEvent, commentPost, commentSchemaEvent, posts, schemaEvent } from './list'
...
export default async function globalSetup() {
  ...
  relay.seed(schemaEvent(), closedSchemaEvent(), commentSchemaEvent(), commentPost(), ...suggestions, ...canonicals)
  return async () => {
    await relay.close()
  }
}
